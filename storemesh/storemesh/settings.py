"""
Django settings for storemesh project.
...
SECRET_KEY = 'django-insecure-rcf1d-hp*ut^0lm&g!r0r@3t3h0!jkcen@dkx=!5oyj$o=k-$3'
...
WSGI_APPLICATION = 'storemesh.wsgi.application'
